...
export default function Tecnologia() {
	return (
		<>
			<div className='lg:flex lg:flex-col lg:text-justify'>
				<div className='pb-72 flex flex-col '>
					...
					<div className='flex flex-col items-center lg:items-start lg:flex-row pt-40 lg:px-40 text-justify px-4'>
						...
						<img
							className='hidden h-[550px] lg:block'
							src='/columncubes.svg'
							alt=''
						/>
					</div>
